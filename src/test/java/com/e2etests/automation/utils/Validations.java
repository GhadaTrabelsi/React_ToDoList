...
//		Assert.assertEquals(text1, text);
	...
	public void assertFalse(WebElement element, String text) {
		String text1 = element.getText();
		Assert.assertTrue(!text1.contains(text));
		System.out.println("success");

	}
	public void assertTrueCase(Boolean condition) {
...
//	}
	public boolean isElementNotPresent(WebElement element) {
	    boolean isNotPresent = !element.isDisplayed();
	    if (isNotPresent) {
	        System.out.println("Element non présent");
	    } else {
	        System.out.println("Element présent");
	    }
	    return isNotPresent;
	}
	...
	public boolean isElementNoPresent(WebElement element) {
	    try {
	        return !element.isDisplayed();
	    } catch (NoSuchElementException e) {
	        return true;
